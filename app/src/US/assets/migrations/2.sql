...
create table LoggedInUserDetail(Id INTEGER, ClubId INTEGER, CustId INTEGER, DistrictId INTEGER, IsTeamLeader INTEGER, LoginID VARCHAR, Name VARCHAR, Password VARCHAR, RefNo INTEGER, StateId INTEGER, TeamId INTEGER);
